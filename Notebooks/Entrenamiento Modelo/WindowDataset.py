...
class WindowGenerator():
    def __init__(self, input_width, label_width, shift, batch,
        ...
        self.column_indices = {name: i for i, name in
                               enumerate(inputs_columns)}

        # Store the raw data.
        self.train_df = train_df[inputs_columns]
        self.val_df = val_df[inputs_columns]
        self.test_df = test_df[inputs_columns]
    ...
    def make_dataset(self, data, batch_size,suffle=True):
    ...
    @property
    def test(self):
        return self.make_dataset(self.test_df,suffle=False,batch_size=32)
